% TO EDIT THE OVERLEAF VERSION: https://www.overleaf.com/6523213312sftmvvjjrfhy
...
\graphicspath{ {./sim_files/}{./cad_files/}{./system_sim_files/}{./misc_plots/}{./system_cad_files/} }
...
\usepackage{float} % To use \figure[H]
...
\end{table}
\footnotetext{These parameters are not final and are slightly adjusted later during system validation (see Section \ref{sec: system_validation}).}
...
\begin{figure}[!htb] 
    \centering
    \includegraphics[scale=0.5, width=0.5\textwidth, trim={0cm 9.85cm 23.5cm 4.5cm}, clip]{Aphlex1B_04-02-2020_P&ID.pdf} %L, B, R, T
...
\begin{figure}[!htb] 
    \centering
    \includegraphics[scale=0.5, width=0.5\textwidth, trim={7.6cm 9.85cm 14.1cm 4cm}, clip]{Aphlex1B_04-02-2020_P&ID.pdf} %L, B, R, T
...
\begin{figure}[!htb] 
    \centering
    \includegraphics[scale=0.5, width=0.6\textwidth, trim={5cm 0cm 14cm 14cm}, clip]{Aphlex1B_04-02-2020_P&ID.pdf} %L, B, R, T
...
\begin{figure}
    ...
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[scale=0.5, width=0.9\textwidth, trim={5cm 0cm 5cm 0cm}, clip]{system_cad_files/master_stand_no_engine.png} % left, bottom, right, top
    ...
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[scale=0.5, width=0.9\textwidth, trim={5cm 0cm 5cm 0cm}, clip]{system_cad_files/master_stand_v42.png} % second figure itself
...
\begin{figure}
    ...
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[scale=0.5, width=0.9\textwidth, trim={5cm 0cm 5cm 0cm}, clip]{system_cad_files/master_upper_plate.png} % left, bottom, right, top
        \caption{The upper plate (upstream of flight tank).}
        \label{fig:upper_plate}
    \end{minipage}\hfill
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[scale=0.5, width=0.9\textwidth, trim={6cm 0cm 4cm 0cm}, clip]{system_cad_files/master_board_v40.png} % second figure itself
...
\begin{figure}
    ...
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[scale=0.5, width=0.9\textwidth, trim={5cm 0cm 5cm 0cm}, clip]{system_cad_files/master_lower_plate.png} % left, bottom, right, top
        \caption{The lower plate (downstream of flight tank).}
        \label{fig:lower_plate}
    \end{minipage}\hfill
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[scale=0.5, width=0.9\textwidth, trim={5cm 0cm 5cm 0cm}, clip]{system_cad_files/master_post_tank_board_v6.png} % second figure itself
...
\begin{figure}
    ...
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[scale=0.5, width=0.9\textwidth, trim={5cm 0cm 5cm 0cm}, clip]{cad_files/Rail Assembly v25.png} % left, bottom, right, top
        \caption{The rail assembly.}
        \label{fig:rail_assembly}
    \end{minipage}\hfill
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[scale=0.5, width=0.9\textwidth, trim={5cm 0cm 5cm 0cm}, clip]{cad_files/Linear Slide v14 FRONT.png} % second figure itself
...
\begin{figure}
    ...
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[scale=0.5, width=0.9\textwidth, trim={5cm 0cm 5cm 0cm}, clip]{cad_files/Linear Slide v14.png} % left, bottom, right, top
        \caption{The full linear slide assembly.}
        \label{fig:linear_slide_assembly}
    \end{minipage}\hfill
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[scale=0.5, width=0.9\textwidth, trim={5cm 0cm 5cm 0cm}, clip]{cad_files/Rail System Test Stand.png} % second figure itself
...
\begin{figure}
    ...
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[scale=0.5, width=0.9\textwidth, trim={0cm 0cm 0cm 0cm}, clip]{system_sim_files/stanford_valve_oldmass_thrust.png} % left, bottom, right, top
        \caption{Thrust output of the simulation code with both MPVs modelled.}
        \label{fig:stanford_valve_old_thrust}
    \end{minipage}\hfill
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[scale=0.5, width=0.9\textwidth, trim={0cm 0cm 0cm 0cm}, clip]{system_sim_files/stanford_valve_oldmass_fuel.png} % second figure itself
...
\begin{figure}
    ...
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[scale=0.5, width=0.9\textwidth, trim={0cm 0cm 0cm 0cm}, clip]{system_sim_files/stanford_novalve_oldmass_thrust.png} % left, bottom, right, top
        \caption{Thrust output of the simulation code with the $N_{2}O$ MPV removed.}
        \label{fig:stanford_novalve_old_thrust}
    \end{minipage}\hfill
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[scale=0.5, width=0.9\textwidth, trim={0cm 0cm 0cm 0cm}, clip]{system_sim_files/stanford_novalve_oldmass_fuel.png} % second figure itself
...
\begin{figure}[!htb] 
    \centering
    \includegraphics[scale=0.5, width=0.55\textwidth, trim={0cm 0cm 0cm 0cm}, clip]{system_sim_files/stanford_final_thrust.png} %L, B, R, T
...
\begin{figure}
    ...
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[scale=0.5, width=0.9\textwidth, trim={0cm 0cm 0cm 0cm}, clip]{system_sim_files/stanford_final_fuel.png} %L, B, R, T
        \caption{Mass flow rate plots without an $N_{2}O$ MPV and with the updated initial masses.}
        \label{fig:stanford_final_thrust}
    \end{minipage}\hfill
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[scale=0.5, width=0.9\textwidth, trim={0cm 0cm 0cm 0cm}, clip]{system_sim_files/stanford_final_pressures.png} %L, B, R, T
...
\begin{figure}
    ...
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[scale=0.5, width=0.9\textwidth, trim={0cm 0cm 0cm 0cm}, clip]{system_sim_files/stanford_final_dp.png} % left, bottom, right, top
    ...
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[scale=0.5, width=0.9\textwidth, trim={0cm 0cm 0cm 0cm}, clip]{system_sim_files/stanford_final_temperatures.png} % second figure itself
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[scale=0.5, width=0.9\textwidth, trim={0cm 0cm 0cm 0cm}, clip]{system_sim_files/stanford_final_nozzle.png} % left, bottom, right, top
    ...
    \begin{minipage}{0.49\textwidth}
        \centering
        \includegraphics[scale=0.5, width=0.9\textwidth, trim={0cm 0cm 0cm 0cm}, clip]{system_sim_files/stanford_final_performance.png} % second figure itself
